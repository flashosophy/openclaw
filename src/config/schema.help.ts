...
export const FIELD_HELP: Record<string, string> = {
  ...
  "tools.exec.commandHighlighting":
    "Show parser-derived command highlights in exec approval prompts (default: true). Disable this to render plain command text without changing exec approval policy.",
